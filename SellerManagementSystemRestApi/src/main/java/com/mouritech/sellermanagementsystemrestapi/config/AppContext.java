...
@ComponentScan({
	"com.mouritech.sellermanagementsystemrestapi"
})
@EnableJpaRepositories(basePackages = "com.mouritech.sellermanagementsystemrestapi.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mouritech.sellermanagementsystemrestapi.entity"
		});
